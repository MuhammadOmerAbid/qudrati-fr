      ...
      <div style={s.wrapper}>
        <div style={s.pageHeader}>
          <div style={s.headerLeft}>
            ...
            <div>
              <h1 style={s.pageTitle}>Add Supplier</h1>
              <p style={s.pageSubtitle}>Create a supplier entry with contact details</p>
            </div>
          </div>
        ...
        <div style={s.card}>
          ...
          <div style={s.footer}>
            <button type="button" style={s.cancelBtn} onClick={() => router.push('/settings/supplier')}>Cancel</button>
            <button type="button" style={saving ? s.saveBtnDisabled : s.saveBtn} onClick={handleSave} disabled={saving}>
              <Save size={15} /> {saving ? 'Saving...' : 'Save Supplier'}
            </button>
          </div>
