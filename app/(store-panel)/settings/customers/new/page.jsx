      ...
      <div style={s.wrapper}>
        <div style={s.pageHeader}>
          <div style={s.headerLeft}>
            ...
            <div>
              <h1 style={s.pageTitle}>Add Customer</h1>
              <p style={s.pageSubtitle}>Create a customer entry with contact details</p>
            </div>
          </div>
        ...
        <div style={s.card}>
          ...
          <div style={s.footer}>
            <button type="button" style={s.cancelBtn} onClick={() => router.push('/settings/customers')}>Cancel</button>
            <button type="button" style={saving ? s.saveBtnDisabled : s.saveBtn} onClick={handleSave} disabled={saving}>
              <Save size={15} /> {saving ? 'Saving...' : 'Save Customer'}
            </button>
          </div>
