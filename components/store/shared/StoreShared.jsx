  ...
  const downloadReportPdf = async () => {
            ...
            if (col.rowSpan && groupKey && groupState.sizes[groupKey] > 1) {
              cells.push({
                ...
                styles: {
                  valign: 'middle',
                  fontStyle: 'normal',
                  fillColor: patientPdfTable ? [255, 255, 255] : [255, 255, 255],
                  textColor: patientPdfTable ? [35, 35, 35] : [39, 53, 41],
                },
              })
              return cells
            }
    ...
    autoTable(doc, {
      ...
      styles: {
        ...
        overflow: 'linebreak',
        textColor: patientPdfTable ? [38, 38, 38] : [39, 53, 41],
        lineColor: patientPdfTable ? [160, 160, 160] : [215, 225, 234],
        lineWidth: patientPdfTable ? 0.35 : 0.45,
        fillColor: [255, 255, 255],
        valign: patientPdfTable ? 'middle' : 'top',
        ...(patientPdfTable ? { minCellHeight: 14 } : {}),
      },
      headStyles: {
        fillColor: patientPdfTable ? [245, 247, 246] : [248, 250, 252],
        textColor: patientPdfTable ? [24, 24, 24] : [15, 23, 42],
        fontStyle: 'bold',
        lineColor: patientPdfTable ? [120, 120, 120] : [215, 225, 234],
        lineWidth: patientPdfTable ? 0.45 : 0.45,
        ...(patientPdfTable ? {
          fontSize: 6.6,
      ...
      alternateRowStyles: { fillColor: patientPdfTable ? [250, 250, 250] : [252, 252, 252] },
      columnStyles,
      tableLineColor: patientPdfTable ? [120, 120, 120] : [215, 225, 234],
      tableLineWidth: patientPdfTable ? 0.45 : 0.45,
      showHead: 'everyPage',
    })
