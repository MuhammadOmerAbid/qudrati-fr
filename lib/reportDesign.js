  ...
  <head>
    ...
    <style>
      * { box-sizing: border-box; }
      ...
      .table-shell { border: 1px solid #d7e1ea; overflow: hidden; background: #fff; }
      table { width: 100%; border-collapse: collapse; table-layout: ${isWideReport ? 'fixed' : 'auto'}; }
      th { background: #f8fafc; color: #0f172a; text-align: left; font-size: 10.5px; border-right: 1px solid #d7e1ea; border-bottom: 1px solid #d7e1ea; padding: 9px 8px; font-weight: 800; text-transform: none; letter-spacing: 0; overflow-wrap: normal; word-break: normal; }
      td { border-top: 1px solid #d7e1ea; border-right: 1px solid #d7e1ea; padding: 8px 8px; vertical-align: top; color: #273529; font-weight: 400; line-height: 1.35; background: #fff; overflow-wrap: break-word; word-break: normal; }
      .entry-cell { vertical-align: middle; font-weight: 400; color: #273529; background: #fff; }
      .group-start td { border-top: 1px solid #d7e1ea; }
      .group-start .entry-cell { border-left: 1px solid #d7e1ea; background: #fff; }
      .group-cont td { border-top: 1px solid #d7e1ea; }
      ...
      .go-meta-table td { width: 20%; min-height: 48px; padding: 8px 10px; border: 1px solid #d7e1ea; border-top: none; vertical-align: top; background: #eef6fc; }
      .go-meta-table tr:first-child td { border-top: 1px solid #d7e1ea; }
      ...
      @media print {
        ...
        th { background: #f8fafc !important; color: #0f172a !important; border-color: #d7e1ea !important; font-size: ${isWideReport ? '7.2px' : '9.2px'}; padding: ${isWideReport ? '4px 4px' : '7px 6px'}; letter-spacing: 0; line-height: 1.15; }
        td { background: #fff !important; border-color: #d7e1ea !important; font-size: ${isWideReport ? '7.4px' : '9.5px'}; padding: ${isWideReport ? '4px 4px' : '6px 6px'}; line-height: 1.16; overflow-wrap: break-word; word-break: normal; }
        .entry-cell { background: #fff !important; border-left-color: #d7e1ea !important; }
        .group-start td { border-top-color: #d7e1ea !important; }
        .footer { margin-top: 10px; }
        .go-card { margin-bottom: 8px; }
        .go-meta-table { table-layout: fixed !important; background: #eef6fc !important; }
        .go-meta-table td { width: 20% !important; min-height: 34px; padding: 5px 6px; background: #eef6fc !important; border-color: #d7e1ea !important; }
