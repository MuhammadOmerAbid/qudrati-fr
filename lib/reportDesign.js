  ...
  <head>
    ...
    <style>
      * { box-sizing: border-box; }
      ...
      .entry-cell { vertical-align: middle; font-weight: 700; color: #123416; background: #fbfdfb; }
      .group-start td { border-top: 1.5px solid ${REPORT_GREEN_MID}; }
      .group-start .entry-cell { border-left: 2px solid ${REPORT_GREEN_MID}; background: #f2f8f3; }
      .group-cont td { border-top: 1px solid #dce8dd; }
      tr:nth-child(even) td { background: #f8fbf8; }
      tr:nth-child(even) td.entry-cell { background: #f8fbf8; }
      .group-start:nth-child(even) .entry-cell { background: #f2f8f3; }
      ...
      @media print {
        ...
        .content { padding: ${isWideReport ? '5mm' : '7mm'}; }
        .header { padding: ${isWideReport ? '5mm' : '7mm'}; background: ${REPORT_GREEN} !important; }
        .company, .suffix, .eyebrow, h1, .subtitle { color: #fff !important; }
        .logo-frame { background: #fff !important; }
        ...
        th { background: ${REPORT_GREEN} !important; color: #fff !important; font-size: ${isWideReport ? '6.8px' : '9.2px'}; padding: ${isWideReport ? '4px 3px' : '7px 6px'}; letter-spacing: ${isWideReport ? '0' : '.2px'}; }
        td { font-size: ${isWideReport ? '7px' : '9.5px'}; padding: ${isWideReport ? '4px 3px' : '6px 6px'}; line-height: 1.18; overflow-wrap: anywhere; word-break: normal; }
        .entry-cell { background: #f2f8f3 !important; border-left-color: ${REPORT_GREEN_MID} !important; }
        .group-start td { border-top-color: ${REPORT_GREEN_MID} !important; }
