  ...
  <head>
    ...
    <style>
      * { box-sizing: border-box; }
      ...
      .logo-frame { width: 86px; height: 74px; border-radius: 14px; background: #fff; display: flex; align-items: center; justify-content: center; padding: 8px; flex: 0 0 auto; box-shadow: inset 0 0 0 1px rgba(255,255,255,.55); }
      ...
      @media print {
        ...
        .content { padding: 5mm; }
        .header { padding: 5mm; background: ${REPORT_GREEN} !important; }
        ...
        td { font-size: ${isWideReport ? '8.4px' : '9.5px'}; padding: ${isWideReport ? '5px 5px' : '6px 6px'}; line-height: 1.18; overflow-wrap: anywhere; word-break: normal; }
