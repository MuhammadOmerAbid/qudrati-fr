  ...
  <head>
    ...
    <style>
      * { box-sizing: border-box; }
      ...
      .logo-frame { width: 92px; height: 74px; display: flex; align-items: center; justify-content: center; padding: 0; flex: 0 0 auto; }
...
export function addPdfReportHeader(doc, { title, subtitle = '', filters = [], logoImage = null }) {
  ...
  if (logoImage?.dataUrl) {
    doc.addImage(logoImage.dataUrl, 'PNG', left, top - 12, 54, 46)
  }
