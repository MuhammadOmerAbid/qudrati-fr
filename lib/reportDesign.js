  ...
  <head>
    ...
    <style>
      * { box-sizing: border-box; }
      ...
      .group-start td { border-top: 2px solid ${REPORT_GREEN_MID}; }
      .group-start .entry-cell { border-left: 4px solid ${REPORT_GREEN_MID}; background: #f2f8f3; }
      .group-cont td { border-top: 1px solid #dce8dd; }
      .group-cont td:first-child { border-left: 4px solid transparent; }
