  ...
  <head>
    ...
    <style>
      * { box-sizing: border-box; }
      ...
      @media print {
        ${isWideReport ? '@page { size: A4 landscape; margin: 8mm; }' : '@page { size: A4 portrait; margin: 10mm; }'}
        body { background: #fff; }
        .page { width: 100%; margin: 0; border: none; box-shadow: none; }
        .content { padding: 7mm; }
        .header { padding: 7mm; background: ${REPORT_GREEN} !important; }
        ...
        td { font-size: ${isWideReport ? '8.4px' : '9.5px'}; padding: ${isWideReport ? '5px 5px' : '6px 6px'}; line-height: 1.22; overflow-wrap: anywhere; word-break: normal; }
